---
description: Turn CCC Review (Codex reviews Claude's changes) on, off, or show status. Usage /ccc-review:ccc-review on [task description] | off | status
...
Codex review is NOT active. Tell the user exactly that, and that the `ccc-review`
