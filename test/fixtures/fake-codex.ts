// Fake `codex` executable. Behaviour comes from $FAKE_CODEX_DIR/steps.json
// (a queue consumed one step per invocation); every invocation is recorded
// as $FAKE_CODEX_DIR/call-<n>.json with its argv, stdin and cwd.
